...
while True:
  ...
  # is_valid = re.search("\d$", numbers_before_vd)
  # is_valid = re.search("\d{6,7}$", numbers_before_vd)
  # is_valid = re.search(" ^[1-9]\d{6,7}$", numbers_before_vd)
  print(numbers_before_vd)
  print(type(numbers_before_vd))
  # number with 6 or 7 digits, no start with 0
  if re.match("^[1-9]\d{1,7}$", numbers_before_vd):
  # if re.match(" ^[1-9]\d{6,7}$", numbers_before_vd):
    break
    # print("match")
    # print(is_valid)
    # if is_valid:
